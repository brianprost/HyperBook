...
export const RouteOptionCard = (props) => {
  return (
    <div className="relative flex flex-col p-8 bg-zinc-300 rounded-2xl border-[6px] border-red-700">
      <h3 className="text-4xl xl:text-5xl underline font-Montserrat font-bold text-center tracking-tighter px-auto mb-10">
        {props.timeOfDay}
      </h3>
      <p className="flex items-baseline my-4 justify-center">
        <span className="text-3xl font-Montserrat font-bold tracking-wide p-2 text-center border-2 border-red-700 rounded-xl w-2/3 bg-zinc-200">
          {props.departureTime}
        </span>
      </p>
