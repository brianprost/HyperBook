      ...
      <div className="lg:col-span-2 col-span-3 space-y-8 px-12">
        <div className="mt-8 p-4 relative flex flex-col sm:flex-row sm:items-center bg-white shadow rounded-lg">
          ...
          <div className="absolute sm:relative sm:top-auto sm:right-auto ml-auto right-4 top-4 text-gray-400 hover:text-gray-800 cursor-pointer">
            <button
              type="button"
              className="bg-hyperred font-Montserrat px-3 py-1 text-hypertan rounded-xl"
            >
              Autofill
            </button>
          </div>
        ...
        <div className="rounded-lg">
          <form id="payment-form" method="POST" action="">
            <h2 className="uppercase tracking-wide text-lg  font-Montserrat text-gray-700 my-2">
            ...
            <fieldset className="mb-3 bg-white shadow-lg rounded text-gray-600">
              ...
              <label className="inline-flex w-2/4 border-gray-200 py-6">
                <span className="text-right px-2 font-Montserrat">State</span>
                <input
                  name="state"
                  className="focus:outline-none px-3 w-full"
                  placeholder="VA"
        ...
        <div className="rounded-md">
          ...
          <fieldset className="mb-3 bg-white shadow-lg rounded text-gray-600">
            <label className="flex border-b border-gray-200 h-12 py-8 items-center">
              <span className="text-right px-2 font-Montserrat">Card</span>
              <input
                name="card"
                className="focus:outline-none px-3 w-full"
